    ...
    internal class Http
    {
        public class requestparam
        {
            ...
            public requestparam(string uri,
                HttpMethod method = null, string data = null, string authtoken = null, string contenttype = null, string accept = null)
            {
                this.uri = uri;
        ...
        public static string request(requestparam param, out bool resultsign)
        {
            ...
            if (null != param)
            {
                ...
                __request.Accept = !string.IsNullOrEmpty(param.accept) ? param.accept : "text/plain";

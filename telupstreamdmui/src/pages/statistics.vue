  ...
  <a-layout>
    ...
    <a-layout-content class="acontent" :class="winwidth>winwidthmodelimit&&!ismobile?collapsed?'acontentlite':'acontentfull':null">
      <div :class="!ismobile?(winwidth>winwidthmodelimit?'vcontentlite':'vcontentfull'):'vcontentfull'">
        ...
        <div>
          <div>
            <a-table v-if="false" :columns="table_columns" :data-source="table_datasource" :pagination="{ pageSize: 100 }" size="small">
            ...
            <div style="height:600px;line-height:600px;color:#666;" class="noselect">
              <span>
                本页统计功能暂未设计，欢迎提供统计策略线索，敬请期待
              </span>
            </div>
          </div>
          <div>
